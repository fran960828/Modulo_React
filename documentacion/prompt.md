...
- Uso de librerias de terceros en typescript: ejemplo usando lodash que es una libreria de javascript empleando @tipes.
- Uso de librerias de terceros diseñadas para typescript como zod
